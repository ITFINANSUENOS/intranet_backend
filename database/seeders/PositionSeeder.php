...
class PositionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('positions')->insert([
            ...
            [
                'name_position' => 'Analista de RRHH',
                'description_position' => 'Apoyo en la gestión de talento humano, nómina y procesos de selección.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name_position' => 'Analista de Servicio al Cliente',
                'description_position' => 'Análisis de la satisfacción del cliente y mejora de la experiencia de servicio.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                'name_position' => 'Analista de Sistemas',
                'description_position' => 'Análisis, diseño e implementación de soluciones informáticas y sistemas.',
                'created_at' => now(),
                'updated_at' => now(),
            ],
            ...
            [
                'name_position' => 'Auxiliar de Servicios Generales',
            ...
            [
                'name_position' => 'Jefe / Administrador',
            ...
            [
                'name_position' => 'Coordinador de Crédito y Cartera CAC',
